...
RegisterNetEvent('jffm:client:takeDrug', function(drugItem)
...
lib.callback.register('jffm:client:isDrugOnCooldown', function(drugItem)
...
lib.callback.register('jffm:client:getCurrentDrugEffect', function()
    return currentDrug
end)